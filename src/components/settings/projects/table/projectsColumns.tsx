...
const getBillableCell = defineEditableTableCell<ProjectRow, 'isBillable'>((value, updateValue) => {
  if (isNull(value)) {
    return null
  }

  return h(BillableSelectBadge, { modelValue: value, 'onUpdate:modelValue': updateValue })
})
