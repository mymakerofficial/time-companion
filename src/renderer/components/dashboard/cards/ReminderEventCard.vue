  ...
  <div>
    <div class="flex flex-row justify-between items-center gap-8">
      <div class="flex-grow flex items-center gap-4">
        <span
          v-provide-color="reminder.color"
          class="size-3 rounded-sm bg-color"
        />
      ...
      <div class="flex flex-row items-center gap-2">
        <Button
          ...
          variant="secondary"
          size="sm"
          >{{ $t('dashboard.controls.startEvent') }}</Button
        >
        <DropdownMenu>
          <DropdownMenuTrigger>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem @click="handleDismiss()">{{
              $t('dashboard.controls.dismissReminder')
            }}</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
